...
namespace EmpManagment.Areas.User.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public AdministrationController(RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IAccountRepository accountRepository, ILogger<AdministrationController> logger)
        {
        ...
        public async Task<IActionResult> Users()
        {
            ...
            else
            {
                ...
                return View(userManager.Users.Where(u => u.Id != userId && u.Id != "8d7e126e-738b-4a9a-9de4-86b6aa26f2d1"));
            }
        }
        [HttpGet]
        [Authorize(Policy = "EditRolePolicy")]
